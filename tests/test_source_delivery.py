...
def test_theme_source_delivery_contains_only_the_explicit_theme_surface():
    ...
    assert {
        ...
        "compositions/background/composition.toml",
        "compositions/background/runtime.py",
        "compositions/background/strand.toml",
        ...
        "compositions/client_theme/composition.toml",
        "compositions/client_theme/runtime.py",
        "compositions/client_theme/sway_theme.toml",
        "compositions/color/composition.toml",
        "compositions/color/runtime.py",
        "compositions/color/strand.toml",
        "compositions/focused_tab_title_colors/composition.toml",
        "compositions/focused_tab_title_colors/focused_tab_title_colors.toml",
        "compositions/focused_tab_title_colors/runtime.py",
        "compositions/focused_tab_title_colors/strand.toml",
